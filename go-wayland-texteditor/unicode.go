...
func init() {
	...
	_ = (&UnicodeFont).Load("supplement.png", supplementDescriptor, "")
	_ = (&UnicodeFont).Load("spacingmod.png", spacingmodDescriptor, "")
	_ = (&UnicodeFont).Load("ipa.png", ipaDescriptor, "")
	_ = (&UnicodeFont).Load("greek.png", greekDescriptor, "")
	_ = (&UnicodeFont).Load("cyrillic.png", cyrillicDescriptor, "")
	_ = (&UnicodeFont).Load("vietnamese.png", vietnameseDescriptor, "")
	_ = (&UnicodeFont).Load("hangul0.png", hangul0Descriptor, "")
	_ = (&UnicodeFont).Load("hangul1.png", hangul0Descriptor, "1")
	_ = (&UnicodeFont).Load("hangul9.png", hangul9Descriptor, "")
	...
	_ = (&UnicodeFont).Load("armenian.png", armenianDescriptor, "")

	_ = (&UnicodeFont).Load("chinese1.jpg", chinese1Descriptor, "")

	_ = (&UnicodeFont).Load("devanagari1.png", devanagari1Descriptor, "")
	_ = (&UnicodeFont).Load("devanagari2.png", devanagari2Descriptor, "")
	_ = (&UnicodeFont).Load("devanagari3.png", devanagari3Descriptor, "")
	...
	_ = (&UnicodeFont).Combine("ऻ", devanagari1Descriptor, "")
	_ = (&UnicodeFont).Combine("ि", devanagari1Descriptor, "")
	_ = (&UnicodeFont).Combine("ी", devanagari1Descriptor, "")
	_ = (&UnicodeFont).Combine("े", devanagari1Descriptor, "")
	_ = (&UnicodeFont).Combine("ॅ", devanagari1Descriptor, "")
	_ = (&UnicodeFont).Combine("ॆ", devanagari1Descriptor, "")
	_ = (&UnicodeFont).Combine("ै", devanagari1Descriptor, "")
	_ = (&UnicodeFont).Combine("ॉ", devanagari1Descriptor, "")
	_ = (&UnicodeFont).Combine("ॊ", devanagari1Descriptor, "")
	_ = (&UnicodeFont).Combine("ो", devanagari1Descriptor, "")
	_ = (&UnicodeFont).Combine("ौ", devanagari1Descriptor, "")
	_ = (&UnicodeFont).Combine("़", devanagari1Descriptor, "")
	_ = (&UnicodeFont).Combine("ॎ", devanagari1Descriptor, "")
	_ = (&UnicodeFont).Combine("ऀ", devanagari1Descriptor, "")
	_ = (&UnicodeFont).Combine("ँ", devanagari1Descriptor, "")
	_ = (&UnicodeFont).Combine("ऺ", devanagari1Descriptor, "")
	_ = (&UnicodeFont).Combine("ु", devanagari1Descriptor, "")
	_ = (&UnicodeFont).Combine("ू", devanagari1Descriptor, "")
	_ = (&UnicodeFont).Combine("ृ", devanagari1Descriptor, "")
	_ = (&UnicodeFont).Combine("ॄ", devanagari1Descriptor, "")
	_ = (&UnicodeFont).Combine("ॏ", devanagari1Descriptor, "")
	_ = (&UnicodeFont).Combine("ॕ", devanagari1Descriptor, "")
	_ = (&UnicodeFont).Combine("ॖ", devanagari1Descriptor, "")
	_ = (&UnicodeFont).Combine("ॗ", devanagari1Descriptor, "")
	_ = (&UnicodeFont).Combine("ॢ", devanagari1Descriptor, "")
	_ = (&UnicodeFont).Combine("ॣ", devanagari1Descriptor, "")

	_ = (&UnicodeFont).Combine("ों", devanagari1Descriptor, "")
	_ = (&UnicodeFont).Combine("ें", devanagari1Descriptor, "")
	_ = (&UnicodeFont).Combine("़ा", devanagari1Descriptor, "")
	_ = (&UnicodeFont).Combine("ो़", devanagari1Descriptor, "")
	_ = (&UnicodeFont).Combine("़ि", devanagari1Descriptor, "")
	_ = (&UnicodeFont).Combine("ूँ", devanagari1Descriptor, "")
	_ = (&UnicodeFont).Combine("़ो", devanagari1Descriptor, "")

	_ = (&UnicodeFont).Combine("ꣿ", "ए", "")
	_ = (&UnicodeFont).Alias("ꣾ", "एꣿ")
	_ = (&UnicodeFont).Alias("क़्", "क़्")
	_ = (&UnicodeFont).Alias("ख़्", "ख़्")
	_ = (&UnicodeFont).Alias("ग़्", "ग़्")
	_ = (&UnicodeFont).Alias("ज़्", "ज़्")
	_ = (&UnicodeFont).Alias("ड़्", "ड़्")
	_ = (&UnicodeFont).Alias("ढ़्", "ढ़्")
	_ = (&UnicodeFont).Alias("फ़्", "फ़्")
	_ = (&UnicodeFont).Alias("य़्", "य़्")
	_ = (&UnicodeFont).Alias("ड़", "ड़")
	_ = (&UnicodeFont).Alias("ढ़", "ढ़")
	_ = (&UnicodeFont).Alias("ॴ", "आऺ")
	_ = (&UnicodeFont).Alias("ॶ", "अॖ")
	_ = (&UnicodeFont).Alias("ॷ", "अॗ")
	_ = (&UnicodeFont).Alias("ॵ", "अॏ")
	_ = (&UnicodeFont).Alias("ॲ", "अॅ")
	_ = (&UnicodeFont).Alias("ꣲ", "ँ")
	_ = (&UnicodeFont).Alias("॰", "°")
