...
replace github.com/danfragoso/thdwb/mustard => ./go-wayland-browser/mustard

replace github.com/danfragoso/thdwb/assets => ./go-wayland-browser/assets
...
require (
	...
	github.com/tadvi/winc v0.0.0-20210907234902-33fdab6e7e58 // indirect
